...
export function Navbar() {
  ...
  return (
    <div className=" border-b-4 border-black-500 relative w-full bg-white py-3">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          <Link to={'/'}>
            <img src={logo} style={{width:"80px"}} alt="Buildhub" srcSet="" />
          </Link>
        </div>
              ...
              <div className="px-5 pb-6 pt-5">
                ...
                <div className="mt-5 flex gap-5">
                  ...
                  <Link
                    to={'/login'}
                    type="button"
                    className="w-full rounded-md bg-black px-3 py-2 text-md font-semibold text-white shadow-sm hover:bg-black/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Log In
                  </Link>
                </div>
