...
const data = [
  { mobile: '9370891272', planType: 'Prepaid', operator: 'Airtel', amount: 199, status: 'Success' },
  { mobile: '9370891234', planType: 'Postpaid', operator: 'Vodafone', amount: 399, status: 'Failed' },
  { mobile: '9370891265', planType: 'Prepaid', operator: 'Jio', amount: 299, status: 'Processing' }
];
